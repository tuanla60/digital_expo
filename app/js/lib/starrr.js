...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        clearButton: '<i class="fas fa-minus-sign"></i>',
    ...
    $(document).ready(function () {
        // Default - (used y kien khach hang page detail pro)
        $("input.rating").rating().on("rating:change", function(event, value, caption) {
            $("input.rating").rating("refresh", {disabled:false, showClear:false});
        });
        // Star page user-review
        $("input.choose-rating").rating().on("rating:change", function(event, value, caption) {
            $("input.choose-rating").rating("refresh", {disabled:false, showClear:false,showCaption:true});
        });
        $("input.result-rating-product").rating("refresh", {disabled:true, showClear:false,showCaption:false}); // Show star average in page product detail
        $("input.customer-rated").rating("refresh", {disabled:true, showClear:false,showCaption:false}); // Star of list customer rated in page product detail
    });
}));
